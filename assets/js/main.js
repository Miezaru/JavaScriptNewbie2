...
var n = prompt('Введите ваше число /// Этот вопрос относится к function evenFn')
function evenFn(n) {
	var number = []
	for (var i = 1; i <= n; i++)
		if (i % 2 === 0) {
...
function ageClassification(num) {
	...
	return num <= 0 ? null : num < 24 ? 'детский возраст' : num < 44 ? 'молодой возраст' : num < 65 ? 'средний возраст' : num < 75 ? 'пожилой возраст' : num < 90 ? 'старческий возраст' : num < 122 ? 'долгожители' : null;
}
